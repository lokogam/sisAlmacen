...
public class LDetalleRecibos {
    ...
    public String registrarDetalleRecibos(DetalleRecibos miDatalle) {
        String msg = null;
        try {
    ...
    public DefaultTableModel mostrarDetalleRecibos(DetalleRecibos miDetalle) {
