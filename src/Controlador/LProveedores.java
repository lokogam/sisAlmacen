...
public class LProveedores {
    ...
    public DefaultTableModel mostrarProveedores(Proveedores miProveedor){
    ...
    public String insertarProveedores(Proveedores miProveedor){
        String msg = null;
        try{
    ...
    public String editarProveedores(Proveedores miProveedor){
        String msg = null;
        try{
    ...
    public String eliminarProveedores(Proveedores miProveedor){
        String msg = null;
        try{
