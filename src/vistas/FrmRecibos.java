...
import Controlador.LAlmacen;
import Controlador.LDetalleRecibos;
import Controlador.LRecibos;
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        if (idrec > 0) {
            ...
            for (int i = 0; i < filas; i++) {
                ...
                DetalleRecibos dtsf = new DetalleRecibos();
